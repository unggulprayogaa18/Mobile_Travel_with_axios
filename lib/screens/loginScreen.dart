                      ...
                      child: GestureDetector(
                        onTap: () {
                          ...
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      RegisterScreen())); // Assuming '/signup' is the route for the sign up screen
                        },
                        child: Text(
                          'Let\'s go Sign up?',
                          style: TextStyle(
                    ...
                    Container(
                      ...
                      child: TextButton(
                        onPressed: () {
                          ...
                          String data = loginController.usernameController.text;
                          SimpanEmail.simpan(data);
